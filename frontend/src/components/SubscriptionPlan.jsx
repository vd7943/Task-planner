...
const SubscriptionPlan = () => {
  ...
  const handlePayment = async (amount) => {
    ...
    try {
      const { data } = await axios.post(
        "https://task-planner-k097.onrender.com/plan/buy-subscription",
        {
          amount,
        },
        ...
        handler: async function (response) {
          ...
          try {
            const verifyRes = await axios.post(
              "https://task-planner-k097.onrender.com/plan/verify-payment",
              payload
            );
  ...
  return (
    <div className="flex flex-col h-screen items-center xl:ml-[170px] my-5 mt-20 xl:mt-5 bg-[#FFFFFF2B] rounded-xl p-4">
